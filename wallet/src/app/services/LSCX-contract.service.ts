...
export class LSCXContractService {
	contracts=['LSCX_ABT', 'LSCX_MDCS', 'LSCX_ISC', 'LSCX_CIF'];
	abis = [];
	bytecodes = [];
	type = "";
	contract;
	...
	addDecimals(functions):any[]{
		let inputsDecimals:any = {
			...
			LSCX_MDCS : {approve: "_value", approveAndCall:"_value" , transferFrom:"_value",  decreaseApproval:"_subtractedValue", transfer:"_value", increaseApproval:"_addedValue"},
		...
		let outputsDecimals: any = {
			...
			LSCX_MDCS : ["totalSupply", "balances", "balanceOf", "allowance", "tokenUnit"],
