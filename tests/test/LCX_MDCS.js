var ModernCash = artifacts.require("ModernCash_MDCS");
var ModernCash2 = artifacts.require("ModernCash_ISC2");


contract('ModernCash Test MDCS',  async (accounts) => {
