var ModernCash = artifacts.require("ModernCash_ISC");
var ModernCash2 = artifacts.require("ModernCash_ISC2");


contract('ModernCash Test ISC',  async (accounts) => {
    ...
    it("check constructor params", async () => {
      ...
      let expectedName = "ModernCash ISC";
      ...
      let expectedStandard = "ERC20 ModernCash ISC Income Smart Contract";
